...
public final class Constants {
    ...
    public static final class ControlCon{
        ...
        public static final class Drive{
            ...
            public static final Joystick sTankDriveBut = new Joystick(kRightStickPort);

            public static final int kArcadeDriveBut = 9;
            public static final Joystick sArcadeDriveBut = new Joystick(kRightStickPort);

            public static final int kSpeedDriveAxis = 1;
            public static final int kTurnDriveAxis = 2;
            public static final Joystick sArcadeDrive = new Joystick(kRightStickPort);
            ...
            public static final Joystick sStraitDriveBut = new Joystick(kRightStickPort);
        }
        public static final class PID{
            public static final int kPIDActiveBut1 = 3;
            public static final Joystick sPIDActiveBut1 = new Joystick(kLeftStickPort);

            public static final int kPIDActiveBut2 = 4;
            public static final Joystick sPIDActiveBut2 = new Joystick(kLeftStickPort);
        }
    ...
    public static final class DriveCon{
        ...
        public static final double kRightSpeedMod = 0.9752;
