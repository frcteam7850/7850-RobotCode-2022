...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(ControlCon.PID.sPIDActiveBut1, ControlCon.PID.kPIDActiveBut1).whenHeld(new PIDDriveCmd(driveSubsystem, 100));
    new JoystickButton(ControlCon.PID.sPIDActiveBut2, ControlCon.PID.kPIDActiveBut2).whenHeld(new PIDDriveCmd(driveSubsystem, -100));
    
    
    new JoystickButton(ControlCon.Drive.sTankDriveBut, ControlCon.Drive.kTankDriveBut).whenActive(
      new TankDriveCmd(driveSubsystem, 
        () -> rightStick.getRawAxis(ControlCon.Drive.kRightDriveAxis), 
        () -> leftStick.getRawAxis(ControlCon.Drive.kLeftDriveAxis), 
        () -> ControlCon.Drive.sStraitDriveBut.getRawButton(ControlCon.Drive.kStraitDriveBut)
    ...
    new JoystickButton(ControlCon.Drive.sArcadeDriveBut, ControlCon.Drive.kArcadeDriveBut).whenActive(
      new ArcadeDriveCmd(driveSubsystem, 
